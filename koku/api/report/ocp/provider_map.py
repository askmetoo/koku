        ...
        self._mapping = [
            {
                ...
                "report_type": {
                    ...
                    "cpu": {
                        ...
                        "sum_columns": ["usage", "request", "limit", "sup_usage", "cost_total"],
                    },
                    "memory": {
                        "aggregates": {
                            "sup_raw": Sum(Value(0, output_field=DecimalField())),
                        ...
                        "sum_columns": ["usage", "request", "limit", "infra_raw", "infra_usage", "cost_total"],
                    },
                    "volume": {
                        ...
                        "sum_columns": ["usage", "request", "infra_raw", "infra_usage", "cost_total"],
                    },
