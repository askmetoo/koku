        ...
        self._mapping = [
            {
                ...
                "report_type": {
                    "costs": {
                        ...
                        "annotations": {
                            # TODO: Figure out if this comment is still relevant
                        ...
                        "sum_columns": ["cost_total", "infra_raw", "infra_usage", "infra_markup"],
                    ...
                    "costs_by_project": {
                        ...
                        "cost_units_key": "currency_code",
                        "cost_units_fallback": "USD",
                        "sum_columns": ["infra_raw", "infra_markup", "infra_usage", "cost_total"],
                    ...
                    "storage": {
                        ...
                        "sum_columns": ["usage", "infra_raw", "infra_markup", "infra_usage", "cost_total"],
                    ...
                    "storage_by_project": {
                        ...
                        "usage_units_key": "unit",
                        "usage_units_fallback": "GB-Mo",
                        "sum_columns": ["usage", "cost_total", "infra_raw", "infra_usage", "infra_markup"],
                        "default_ordering": {"usage": "desc"},
                    },
                    "instance_type": {
                        "aggregates": {
                        ...
                        "sum_columns": ["usage", "cost_total", "infra_raw", "infra_markup", "infra_usage", "count"],
                        "default_ordering": {"usage": "desc"},
                    },
